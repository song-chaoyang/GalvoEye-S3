...
| 目标跟踪 | 无 | **YOLO 目标检测 + 实时跟踪** |
| 交互能力 | 仅 SD 卡播放 | **交互式激光按钮 + 手指点击检测** |
| 安全保护 | 无 | **三层安全保护（PIR + ToF + AI 人脸检测）** |
...
- **第三层**：ESP32-S3 摄像头 AI 人脸检测（直视自动关闭）
...
| 方案 | 配置 | 总成本 |
|------|------|--------|
| **极致省钱版** | ESP32-S3-CAM + 入门振镜 + 单红激光 + 基础安全 | **约 ¥160~250** |
